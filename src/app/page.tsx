...
import {
  ArrowRight, PenTool, Zap, Heart, ShieldCheck,
  Users, TrendingUp, Clock, Star, CheckCircle2,
  Target, Award, FileText, Package, Sparkles, Bolt,
  Mail, MessageSquare,
} from "lucide-react";
    ...
    <main className="relative z-10">
      ...
      <section className="min-h-[80vh] flex flex-col items-center justify-center text-center px-6 pt-8 md:pt-16 pb-16 bg-gradient-to-b from-background via-background to-surface-muted">
        ...
        >
          ...
          <Reveal variant="fade-up" delay={0.2} duration={0.8}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-foreground leading-tight tracking-tight">
              Präzision, die <br />
        ...
        <div className="max-w-7xl mx-auto">
          <Reveal variant="fade-up" duration={0.6}>
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-foreground tracking-tight">
                Das Stickwerk-Versprechen
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <Reveal variant="fade-up" duration={0.6}>
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-foreground">
                Dein Design — selbst gestalten
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Ob Patch oder Namensschild — wähle dein Produkt, passe es an und erhalte sofort eine unverbindliche Kostenschätzung.
              </p>
              <div className="section-divider" />
            </div>
          </Reveal>
      ...
      <section id="cta" className="py-16 md:py-24 px-6 bg-surface-muted">
        <div className="max-w-6xl mx-auto">
          <Reveal variant="fade-up" duration={0.6}>
            <div className="relative rounded-2xl bg-gradient-to-br from-[#3A332C] via-[#4A3F36] to-[#2D2823] p-12 md:p-20 text-center text-[#FCF7EF] overflow-hidden">
              <div
              ...
              <div className="relative z-10 space-y-8">
                ...
                <Reveal variant="fade-up" delay={0.35} duration={0.6}>
                  <p className="text-lg md:text-xl text-card/80 max-w-2xl mx-auto leading-relaxed">
                    Starten Sie noch heute! Wir beraten Sie gerne persönlich oder Sie nutzen unseren Konfigurator.
                  </p>
                </Reveal>
                <Reveal variant="fade-up" delay={0.5} duration={0.6}>
                  <div className="flex flex-wrap justify-center gap-4">
                    <Button
                      size="lg"
                      variant="default"
